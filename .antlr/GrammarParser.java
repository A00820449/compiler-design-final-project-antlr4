...
public class GrammarParser extends Parser {
	...
	public final Term_opContext term_op() throws RecognitionException {
		...
		enterRule(_localctx, 4, RULE_term_op);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class TermContext extends ParserRuleContext {
		...
		public List<Factor_opContext> factor_op() {
			return getRuleContexts(Factor_opContext.class);
		}
		public Factor_opContext factor_op(int i) {
			return getRuleContext(Factor_opContext.class,i);
		}
	...
	public final Factor_opContext factor_op() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_factor_op);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class AtomContext extends ParserRuleContext {
		public TerminalNode NUM_LITERAL() { return getToken(GrammarParser.NUM_LITERAL, 0); }
